...
const CanvasWrapper: FC<{ children: ReactNode }> = ({ children }) => {
  ...
  // If theme is light, we don't render the Canvas at all.
  // This kills the animation loop and the WebGL context to stop the lag.
...
const Beams: FC<BeamsProps> = ({
  ...
  // Kill Switch: Do not render anything if the theme is light
  if (resolvedTheme === 'light') return null;
